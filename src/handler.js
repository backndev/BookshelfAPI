...
const addBookHandler = (request, h) => {
  ...
  const newBook = {
    id, name, year, author, summary, publisher, pageCount, readPage, reading, finished : booleanFinished, insertedAt, updatedAt,
  };
...
module.exports = { addBookHandler, getAllBooksHandler, editBookByIdHandler, deleteBookByIdHandler, getDetailBookByIdHandler };